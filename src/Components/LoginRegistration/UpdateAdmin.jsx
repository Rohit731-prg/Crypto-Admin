...
function UpdateAdmin() {
  ...
  const checkEmail = async () => {
    ...
    try {
        ...
        const res = await axios.post('http://209.126.4.145:4000/admin/getAdminByName', {
            email: email,
            name: userName
        });
  ...
  const setNewPassword = async () => {
    if (passwords.newPassword === passwords.confirmPassword) {
      ...
      const res = await axios.put('http://209.126.4.145:4000/admin/update', {id: adminDetails._id, password: passwords.newPassword});
